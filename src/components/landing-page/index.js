      ...
      <div className="container-fluid p-0">
        ...
        >
          <h2 className="fs-1 fw-bold p-5">
            Tại sao chọn <span className="highlight text-success">TechJ?</span>
          </h2>
          <div className="row p-3">
            ...
            <div className="col-md-4 featureItem">
              ...
              <p className="featureDescription">
                Đội ngũ có năng lực và kinh nghiệm, luôn sẵn sàng giải quyết mọi
                thách thức.
              </p>
            </div>
            <div className="col-md-4 featureItem">
            ...
            <div className="images  mb-4">
              <div className="d-flex gap-5 text-align-center justify-content-between align-items-center">
                ...
                <p className="paragraph text-white">
                  Chúng tôi chuyên phát triển các phần mềm ứng dụng trí tuệ nhân
                  tạo, giúp tối ưu hóa quy trình kinh doanh.Đáp ứng các nhu cầu
                  đặc thù của doanh nghiệp bằng các giải pháp AI được thiết kế
                  riêng, mang lại hiệu quả và tính cạnh tranh cao.
                </p>
              </div>
              <div className="d-flex gap-5 text-align-center justify-content-between align-items-center">
                <p className="paragraph text-white">
                  Hỗ trợ doanh nghiệp tiết kiệm nguồn lực và thời gian với các
                  sản phẩm AI chất lượng cao, triển khai nhanh chóng.Đảm bảo hệ
                  thống luôn được cập nhật công nghệ mới nhất, hoạt động ổn định
                  và hiệu quả lâu dài.
                </p>
                <img
                  className="img-fluid image"
